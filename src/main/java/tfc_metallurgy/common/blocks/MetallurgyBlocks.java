...
public class MetallurgyBlocks {
    ...
    public static final net.neoforged.neoforge.registries.DeferredRegister<Block> BLOCKS = DeferredRegister.createBlocks(TFCMetallurgy.mod_id);

    public static final Map<Rock, Map<MetallurgyOre, DeferredBlock<Block>>> ORES = Helpers.mapOf(Rock.class, rock ->
            Helpers.mapOf(MetallurgyOre.class, ore -> !ore.isGraded(), ore ->
                    register(("ore/" + ore.name() + "/" + rock.name()), () -> ore.create(rock))
            )
    );

    public static final Map<Rock, Map<MetallurgyOre, Map<Ore.Grade, DeferredBlock<Block>>>> GRADED_ORES = Helpers.mapOf(Rock.class, rock ->
    ...
    public static final Map<MetallurgyOre, DeferredBlock<Block>> SMALL_ORES = Helpers.mapOf(MetallurgyOre.class, MetallurgyOre::isGraded, type ->
    ...
    public static final Map<MetallurgyMetal, Map<MetallurgyMetal.BlockType, DeferredBlock<Block>>> METALS = Helpers.mapOf(MetallurgyMetal.class, metal ->
    ...
    public static final DeferredBlock<Block> BERYLLIUM_COPPER_BELL = register("beryllium_copper_bell", () -> new TFCBellBlock(ExtendedProperties.of().mapColor(MapColor.GOLD).requiresCorrectToolForDrops().strength(5.0F).sound(SoundType.ANVIL).blockEntity(MetallurgyBlockEntities.BELL).ticks(BellBlockEntity::serverTick, BellBlockEntity::clientTick), 0.8f, "beryllium_copper"));
    public static final DeferredBlock<Block> FLORENTINE_BRONZE_BELL = register("florentine_bronze_bell", () -> new TFCBellBlock(ExtendedProperties.of().mapColor(MapColor.GOLD).requiresCorrectToolForDrops().strength(5.0F).sound(SoundType.ANVIL).blockEntity(MetallurgyBlockEntities.BELL).ticks(BellBlockEntity::serverTick, BellBlockEntity::clientTick), 0.8f, "florentine_bronze"));
    public static final DeferredBlock<Block> ENDERIUM_BARS = register("enderium_bars", () -> new IronBarsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(6.0F, 7.0F).sound(SoundType.METAL).noOcclusion()));
    public static final DeferredBlock<Block> TITANIUM_BARS = register("titanium_bars", () -> new IronBarsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(6.0F, 7.0F).sound(SoundType.METAL).noOcclusion()));
    public static final DeferredBlock<Block> TUNGSTEN_BARS = register("tungsten_bars", () -> new IronBarsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(6.0F, 7.0F).sound(SoundType.METAL).noOcclusion()));
    public static final DeferredBlock<Block> TUNGSTEN_STEEL_BARS = register("tungsten_steel_bars", () -> new IronBarsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(6.0F, 7.0F).sound(SoundType.METAL).noOcclusion()));

    public static final Map<MetallurgyMetal, DeferredBlock<LiquidBlock>> METAL_FLUIDS = Helpers.mapOf(MetallurgyMetal.class, metal ->
